...
function startRumEventCollection(lifeCycle, hooks, configuration, session, recorderApi, initialViewOptions, customVitalsState, bufferedDataObservable, sdkName, reportError) {
    ...
    const locationChangeObservable = (0, locationChangeObservable_1.createLocationChangeObservable)(configuration);
    ...
    const urlContexts = (0, urlContexts_1.startUrlContexts)(lifeCycle, hooks, locationChangeObservable);
    ...
    const resourceCollection = (0, resourceCollection_1.startResourceCollection)(lifeCycle, configuration, pageStateHistory);
    cleanupTasks.push(resourceCollection.stop);
    const { stop: stopLongTaskCollection } = (0, longTaskCollection_1.startLongTaskCollection)(lifeCycle, configuration);
