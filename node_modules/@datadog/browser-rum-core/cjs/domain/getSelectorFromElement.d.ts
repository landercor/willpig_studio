 ...
 */
export declare function isSelectorUniqueAmongSiblings(currentElement: Element, _rootNode: Document | ShadowRoot, currentElementSelector: string, childSelector: string | undefined): boolean;
