...
function startActionCollection(lifeCycle, hooks, domMutationObservable, windowOpenObservable, configuration) {
    ...
    const stopClickActions = browser_core_1.noop;
    let clickActions;
    if (configuration.trackUserInteractions) {
        clickActions = (0, trackClickActions_1.trackClickActions)(lifeCycle, domMutationObservable, windowOpenObservable, configuration);
    }
    const manualActions = (0, trackManualActions_1.trackManualActions)(lifeCycle, (action) => {
        lifeCycle.notify(12 /* LifeCycleEventType.RAW_RUM_EVENT_COLLECTED */, processAction(action));
    });
