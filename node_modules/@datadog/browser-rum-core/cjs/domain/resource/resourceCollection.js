...
const trackManualResources_1 = require("./trackManualResources");
function startResourceCollection(lifeCycle, configuration, pageStateHistory) {
    const taskQueue = (0, browser_core_1.mockable)(browser_core_1.createTaskQueue)();
    let requestRegistry;
    ...
    (0, browser_core_1.mockable)(retrieveInitialDocumentResourceTiming_1.retrieveInitialDocumentResourceTiming)(configuration, (timing) => {
    ...
    const resourceTracker = (0, eventTracker_1.startEventTracker)(lifeCycle);
    const manualResources = (0, trackManualResources_1.trackManualResources)(lifeCycle, resourceTracker);
    return {
