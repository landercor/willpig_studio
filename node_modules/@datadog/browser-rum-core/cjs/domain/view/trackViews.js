...
function newView(lifeCycle, domMutationObservable, windowOpenObservable, configuration, loadingType, startClocks = (0, browser_core_1.clocksNow)(), viewOptions) {
    ...
    let endClocks;
    const location = (0, browser_core_1.shallowClone)((0, browser_core_1.mockable)(window.location));
